...
# 📄 Professional Resume - Ghazala Perween

Welcome to my resume repository! This project contains my up-to-date professional resume, beautifully designed using clean **HTML5**, **CSS3**, and **JavaScript**.

I am a Computer Engineering diploma holder from Jamia Millia Islamia, passionate about frontend development and open to **Web Developer Internships**.
